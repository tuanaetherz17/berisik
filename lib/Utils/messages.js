...
const mediaAnnotation = [
    {
        ...
        newsletter: {
            // Aetherz@erz@erz@Note 03-02-26 --- You can change jid, message id, and name via .env (⁠≧⁠▽⁠≦⁠)
...
// Aetherz@erz@Changes 31-01-26 --- Extract product message into a standalone function so it can also be reused as the header for interactive messages
const prepareProductMessage = async (message, options) => {
    ...
    // Aetherz@erz@erz@Changes 01-02-26 --- Add product message default value
 ...
 */
// Aetherz@erz@Changes 21-04-26 --- Enhanced prepareStickerPackMessage
const prepareStickerPackMessage = async (message, options) => {
    const { cover, stickers = [], name = '📦 Sticker Pack', publisher = 'GitHub: aetherzxyz', description = '🏷️ berisik' } = message;
    ...
    const logger = options.logger;
    // Aetherz@erz@Changes 01-02-26 --- Add caching for sticker pack
...
const prepareNativeFlowButtons = (message) => {
    ...
    return {
        buttons: correctedField.map(button => {
            ...
            // Aetherz@erz@Changes 12-03-26 --- Add "single_select" shortcut ＼⁠(⁠°⁠o⁠°⁠)⁠／
...
// Aetherz@erz@erz@Changes 06-02-26 --- Validate album message media to avoid bug 👀
...
// Aetherz@erz@erz@Changes 30-01-26 --- Validate carousel cards header to avoid bug 👀
...
export const generateWAMessageContent = async (message, options) => {
    var _a, _b;
    let m = {};
    // Aetherz@erz@Changes 30-01-26 --- Add "raw" boolean to send raw messages directly via generateWAMessage()
    if (hasNonNullishProperty(message, 'raw')) {
        delete message.raw;
        return message;
    }
    // Aetherz@erz@Changes 09-04-26 --- Add support for code block and table with richResponseMessage
        ...
        if (message.poll.toAnnouncementGroup) {
            ...
            // Aetherz@erz@Changes 08-02-26 --- Add quiz message support
            if (message.poll.pollType === 1) {
                ...
                m.pollCreationMessageV5 = {
                    // Aetherz@erz@Note 08-02-26 --- quiz for newsletter only
                    ...pollCreationMessage,
                    correctAnswer: {
    ...
    // Aetherz@erz@Changes 08-02-26 --- Add poll result snapshot message
    ...
    // Aetherz@erz@Changes 08-02-26 --- Add poll update message
    ...
    // Aetherz@erz@Changes 01-02-26 --- Add payment invite message
    ...
    // Aetherz@erz@Changes 01-02-26 --- Add order message
    ...
    // Aetherz@erz@Changes 31-01-26 --- Add support for album messages
